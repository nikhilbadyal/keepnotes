...
import 'package:notes/util/Languages/LanguageEn.dart';
import 'package:notes/util/Languages/LanguageHi.dart';
...
Future<Locale> getLocale() async {
  final languageCode = Utilities.getStringValuesSF('appLocale') ?? 'en';
  return _locale(languageCode);
}
